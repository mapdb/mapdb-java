        ...
        extends ListMultimap<K, V>, ImmutableMultimap<K, V>
{
     ...
     * @since 11.0
     */
    void forEachKeyImmutableList(Procedure2<? super K, ? super ImmutableList<V>> procedure);
    ...
    @Override
    <K2, V2> ImmutableBagMultimap<K2, V2> collectKeyMultiValues(Function<? super K, ? extends K2> keyFunction, Function<? super V, ? extends V2> valueFunction);
