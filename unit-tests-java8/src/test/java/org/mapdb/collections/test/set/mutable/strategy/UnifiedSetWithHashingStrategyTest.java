...
package org.mapdb.collections.test.set.mutable.strategy;
...
import org.mapdb.collections.test.set.mutable.MutableSetTestCase;

public class UnifiedSetWithHashingStrategyTest implements MutableSetTestCase
{
    @SafeVarargs
    @Override
