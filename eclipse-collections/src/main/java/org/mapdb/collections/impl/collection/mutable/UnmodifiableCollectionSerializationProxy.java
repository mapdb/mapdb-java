...
public class UnmodifiableCollectionSerializationProxy<T> implements Externalizable
{
    ...
    public UnmodifiableCollectionSerializationProxy()
    {
        // Empty constructor for Externalizable class
    }

    public UnmodifiableCollectionSerializationProxy(MutableCollection<T> collection)
    {
    ...
    {
        return this.mutableCollection.asUnmodifiable();
    }
}
