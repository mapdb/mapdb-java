...
package org.mapdb.collections.impl.set.mutable.primitive;
...
import org.mapdb.collections.impl.block.factory.primitive.BooleanPredicates;
import org.mapdb.collections.impl.factory.primitive.BooleanSets;
...
public class BooleanHashSet implements MutableBooleanSet, Externalizable
{
    ...
    {
        if (source instanceof BooleanHashSet booleanHashSet)
        {
            return new BooleanHashSet(booleanHashSet);
        }
