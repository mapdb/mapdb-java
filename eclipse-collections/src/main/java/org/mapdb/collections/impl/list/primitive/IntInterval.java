...
import org.mapdb.collections.api.block.function.primitive.ObjectIntIntToObjectFunction;
...
import org.mapdb.collections.api.block.procedure.primitive.IntIntProcedure;
...
import org.mapdb.collections.impl.lazy.primitive.CollectIntToObjectIterable;
import org.mapdb.collections.impl.lazy.primitive.LazyIntIterableAdapter;
import org.mapdb.collections.impl.lazy.primitive.ReverseIntIterable;
import org.mapdb.collections.impl.lazy.primitive.SelectIntIterable;
        ...
        implements ImmutableIntList, Serializable
{
    ...
    /**
     * Returns a new IntInterval with the same elements in the opposite order: it
    ...
    public IntInterval toReversed()
    {
        ...
        // (it is unrepresentable as a positive int), which would build a wrong
        ...
        {
            throw new ArithmeticException("Cannot reverse an IntInterval with the minimum step value");
        }
        ...
        return IntInterval.fromToBy(last, this.from, -this.step);
    }
