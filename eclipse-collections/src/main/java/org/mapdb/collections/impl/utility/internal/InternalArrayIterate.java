...
import org.mapdb.collections.impl.block.procedure.FastListCollectIfProcedure;
import org.mapdb.collections.impl.block.procedure.FastListCollectProcedure;
import org.mapdb.collections.impl.block.procedure.FastListRejectProcedure;
import org.mapdb.collections.impl.block.procedure.FastListSelectProcedure;
...
public final class InternalArrayIterate
{
    ...
    {
        if (target instanceof FastList<?> fastList)
        {
            fastList.ensureCapacity(target.size() + size);
        }
        else if (target instanceof ArrayList<?> arrayList)
        {
            arrayList.ensureCapacity(target.size() + size);
        }
    }
