...
public class AssertTest
{
    ...
    public void nullToString()
    {
        ...
        {
            Verify.assertEquals(
                    "expected: org.mapdb.collections.impl.test.AssertTest$NullToString<null> but "
                            + "was: org.mapdb.collections.impl.test.AssertTest$NullToString<null>",
                    e.getMessage());
            return;
        }
    ...
    public void assertThrowsUsesCanonicalNameUponTypeMismatch()
    {
        ...
        {
            Verify.assertEquals(
                    "unexpected exception type thrown; expected:<org.mapdb.collections.impl.test.AssertTest.NestedException>"
        ...
        catch (AssertionError error)
        {
            Verify.assertEquals(
                    "unexpected exception type thrown; expected:<java.io.IOException>"
                            + " but was:<org.mapdb.collections.impl.test.AssertTest$1>",
                    error.getMessage());
            Verify.assertSame(npe, error.getCause());
            return;
        }
    ...
    public void assertThrowsUsesCanonicalNameWhenRequiredExceptionNotThrown()
    {
        ...
        {
            Verify.assertEquals(
                    "expected org.mapdb.collections.impl.test.AssertTest.NestedException to be thrown,"
